...
data_root = '/home/rui/dataset/kitti_mini/'
class_names = ['Pedestrian', 'Cyclist', 'Car']
# [x, y, z] -> [69.12, 79.36, 4]/[x, y, z] = [432, 496, 1]
            ...
            pipeline=[
                ...
                dict(
                    ...
                    db_sampler=dict(
                        data_root=data_root,
                        info_path=
                        data_root+'kitti_dbinfos_train.pkl',
                        rate=1.0,
                        prepare=dict(
                            filter_by_difficulty=[-1],
...
optimizer_config = dict(grad_clip=dict(max_norm=32, norm_type=2))
lr_config = dict(
    policy='cyclic',
...
log_level = 'INFO'
work_dir = './work_dirs/voxel_encoder64'
load_from = None
resume_from = None
workflow = [('train', 1)]
